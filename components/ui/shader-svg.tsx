...
export function MeshGradientSVG() {
  ...
  useEffect(() => {
    const svg = document.querySelector("[data-shader-hero]");
    if (!svg) return;
  ...
  return (
    <motion.div
      className="relative mx-auto w-full max-w-sm p-4 sm:p-8"
